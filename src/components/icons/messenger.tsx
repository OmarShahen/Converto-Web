...
export const MessengerIcon = ({ width = "42", height = "42" }: IconProps) => {
  return (
    <svg
      width={width}
      height={height}
    ...
    >
      ...
      <defs>
        ...
        >
          <stop offset="0.1137" stop-color="#006DFF"></stop>
